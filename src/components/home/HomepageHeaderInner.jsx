...
const HomepageHeaderInner = styled('div')`
  ...
  padding-top: ${props =>
    `calc(${formatPx(props.theme.pxSizes.heights.header)} + ${formatEm(props.theme.emSizes.containerPadding)})`};
  box-shadow: ${props => transparentize(0.75, props.theme.pallette.grey900)} 0 0 125px inset;
  z-index: 2;

  @media screen and (max-width: ${props => formatPx(props.theme.pxSizes.breakpoints.md - 1)}) {
    padding-top: ${props => `calc(${formatPx(props.theme.pxSizes.heights.header)} + ${formatEm(3.5)})`};
  ...
  @media only screen and (min-width: ${props => formatPx(props.theme.pxSizes.breakpoints.md)}) {
    ...
    padding-top: ${props =>
      `calc(${formatPx(props.theme.pxSizes.heights.header)} + ${formatEm(props.theme.emSizes.containerPadding * 2)})`};
  }
  ...
  @media only screen and (min-width: ${props => formatPx(props.theme.pxSizes.breakpoints.lg)}) {
    ...
    padding-top: ${props =>
      `calc(${formatPx(props.theme.pxSizes.heights.header)} + ${formatEm(props.theme.emSizes.containerPadding * 3)})`};
  }
`;
